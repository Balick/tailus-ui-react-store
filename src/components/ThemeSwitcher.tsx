      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          ...
          >
            <Button.Icon
              type="only"
              className="absolute inset-0 size-2 scale-0 rounded-full bg-white duration-300 dark:scale-100"
            >
              <span />
            </Button.Icon>
            <Button.Icon
              type="only"
              className="size-2 rounded-full bg-gray-950 duration-300 dark:scale-0"
            >
              <span />
            </Button.Icon>
          </Button.Root>
